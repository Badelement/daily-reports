...
**更新时间**: 2026-03-22 06:17:56 (Asia/Shanghai)
...
│ Agents          │ 1 · no bootstrap files · sessions 43 · default main active just now                                │
│ Memory          │ enabled (plugin memory-core) · unavailable                                                         │
│ Probes          │ skipped (use --deep)                                                                               │
│ Events          │ none                                                                                               │
│ Heartbeat       │ 30m (main)                                                                                         │
│ Sessions        │ 43 active · default deepseek-chat (128k ctx) · ~/.openclaw/agents/main/sessions/sessions.json      │
└─────────────────┴────────────────────────────────────────────────────────────────────────────────────────────────────┘
...
│ agent:main:cron:d2e5fda8-439e-4…              │ direct │ just now │ deepseek-chat │ 15k/128k (11%) · 🗄️ 818% cached  │
│ agent:main:main                               │ direct │ 9m ago   │ deepseek-chat │ 67k/128k (53%) · 🗄️ 100% cached  │
...
### 中文摘要
- 最近一次提交：1e19c83 更新系统仪表板状态: 2026-03-22 05:47:56
- 工作区状态：干净
