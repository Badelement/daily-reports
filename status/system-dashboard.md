...
**更新时间**: 2026-03-21 22:48:01 (Asia/Shanghai)
...
│ Agents          │ 1 · no bootstrap files · sessions 28 · default main active just now                                │
│ Memory          │ enabled (plugin memory-core) · unavailable                                                         │
│ Probes          │ skipped (use --deep)                                                                               │
│ Events          │ none                                                                                               │
│ Heartbeat       │ 30m (main)                                                                                         │
│ Sessions        │ 28 active · default deepseek-chat (128k ctx) · ~/.openclaw/agents/main/sessions/sessions.json      │
└─────────────────┴────────────────────────────────────────────────────────────────────────────────────────────────────┘
...
├───────────────────────────────────────────────┼────────┼──────────┼───────────────┼──────────────────────────────────┤
│ agent:main:cron:d2e5fda8-439e-4…              │ direct │ just now │ deepseek-chat │ 16k/128k (13%) · 🗄️ 926% cached  │
│ agent:main:cron:d2e5fda8-439e-4…              │ direct │ just now │ deepseek-chat │ 16k/128k (13%) · 🗄️ 926% cached  │
│ agent:main:main                               │ direct │ 8m ago   │ deepseek-chat │ 95k/128k (74%) · 🗄️ 100% cached  │
│ agent:main:cron:d2e5fda8-439e-4…              │ direct │ 30m ago  │ deepseek-chat │ 16k/128k (13%) · 🗄️ 926% cached  │
│ agent:main:cron:d2e5fda8-439e-4…              │ direct │ 1h ago   │ deepseek-chat │ 16k/128k (12%) · 🗄️ 647% cached  │
│ agent:main:cron:bbbba49f-c5d4-4…              │ direct │ 1h ago   │ deepseek-chat │ 17k/128k (14%) · 🗄️ 1434% cached │
│ agent:main:cron:bbbba49f-c5d4-4…              │ direct │ 1h ago   │ deepseek-chat │ 17k/128k (14%) · 🗄️ 1434% cached │
│ agent:main:cron:d2e5fda8-439e-4…              │ direct │ 2h ago   │ deepseek-chat │ 15k/128k (11%) · 🗄️ 1006% cached │
...
### 中文摘要
- 最近一次提交：06bc6e4 cron: dashboard refresh at 2026-03-21 22:18:23
- 工作区状态：干净
