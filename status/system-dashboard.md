...
**更新时间**: 2026-03-22 05:17:57 (Asia/Shanghai)
...
│ Agents          │ 1 · no bootstrap files · sessions 41 · default main active just now                                │
│ Memory          │ enabled (plugin memory-core) · unavailable                                                         │
│ Probes          │ skipped (use --deep)                                                                               │
│ Events          │ none                                                                                               │
│ Heartbeat       │ 30m (main)                                                                                         │
│ Sessions        │ 41 active · default deepseek-chat (128k ctx) · ~/.openclaw/agents/main/sessions/sessions.json      │
└─────────────────┴────────────────────────────────────────────────────────────────────────────────────────────────────┘
...
├───────────────────────────────────────────────┼────────┼──────────┼───────────────┼──────────────────────────────────┤
│ agent:main:cron:d2e5fda8-439e-4…              │ direct │ just now │ deepseek-chat │ 16k/128k (13%) · 🗄️ 880% cached  │
│ agent:main:cron:d2e5fda8-439e-4…              │ direct │ just now │ deepseek-chat │ 16k/128k (13%) · 🗄️ 880% cached  │
│ agent:main:main                               │ direct │ 9m ago   │ deepseek-chat │ 61k/128k (48%) · 🗄️ 90% cached   │
│ agent:main:cron:d2e5fda8-439e-4…              │ direct │ 30m ago  │ deepseek-chat │ 16k/128k (13%) · 🗄️ 880% cached  │
│ agent:main:cron:d2e5fda8-439e-4…              │ direct │ 1h ago   │ deepseek-chat │ 17k/128k (13%) · 🗄️ 955% cached  │
...
### 中文摘要
- 最近一次提交：b02c6ee chore: update system dashboard snapshot [cron:d2e5fda8-439e-44e2-b475-cdfb4a96c0b0]
- 工作区状态：干净
